...
/**
 * Class to create objects which contain room details of an access attempt or a
 * motor servo.
 *  
 * @author Daniel Hayes
 *
...
public class RoomDetails {
	...
	public String toString() {
		return "RoomDetails [rfidCardId=" + rfidCardId + ", rfidReaderId=" 
				+ rfidReaderId + ", roomNo=" + roomNo + ", lockId=" + lockId 
				+ ", username=" + username +", attemptSuccessful=" 
				+ attemptSuccessful + "]";
	}
